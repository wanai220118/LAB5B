...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    <h1>Update Page</h1>
        <form action="update.php" method="post">
            ...
            <input type="text" name="matric" value="<?php echo $User['matric']; ?>"><br>
            ...
            <select name="role" id="role" required>
                ...
                <input type="submit" value="Update"> <a href="read.php" style="color: blue; text-decoration: underline;">Cancel</a></p>
            </form>
        </body>
